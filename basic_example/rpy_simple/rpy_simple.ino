...
void loop(){
  ...
  float gyro_data[3];
  read_gyro(gyro_raw, gyro_data);
  roll += gyro_data[0] * timeStep;
  pitch += gyro_data[1] * timeStep;
  yaw += gyro_data[2] * timeStep;
  roll  += pitch * sin(gyro_data[2] * timeStep * M_PI / 180);   
  pitch -= roll * sin(gyro_data[2] * timeStep * M_PI / 180); 
